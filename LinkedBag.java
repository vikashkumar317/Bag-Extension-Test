...
// or null otherwise.
    ...
    public boolean equals(LinkedBag<T> aBag) {
        ...
        {
        	int[] visit = new int[this.getCurrentSize()];
        	...
        	Node temp1=aBag.firstNode;
        	int j=0;
        	boolean flag;
        	while(temp!=null)
        	{
        		temp1=aBag.firstNode;
        		j=0;
        		flag=true;
        		while(temp1!=null)
        		{
        			if(visit[j]==0 && (temp.data == temp1.data))
        			{
        				flag=false;
        				visit[j]++;
        				break;
    ...
    public void removeDuplicates() {
        ...
        Node temp=firstNode,temp1=firstNode,temp2=firstNode;
        boolean flag;
        while(temp!=null)
        {
        	temp1=temp.next;
